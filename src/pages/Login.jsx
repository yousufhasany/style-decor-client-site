      ...
      <div className="max-w-5xl mx-auto w-full grid gap-10 md:grid-cols-2 items-center">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className="btn w-full mb-6 gap-2 bg-white text-gray-900 border border-gray-300 shadow-sm hover:bg-purple-50 hover:border-purple-400 flex items-center justify-center font-semibold text-base"
          >
